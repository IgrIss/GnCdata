...
* Requests reshape2 and data.table librareis.
...
* Merges data set and performs aggregations using MELT and DCAST functions from reshape2 library.
* Writes the resulting table into tidy_data.txt
